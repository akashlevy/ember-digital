...
// Filename       : itrx_sync_rstn_scan.v
...
`ifndef ITRX_SYNC_RSTN_SCAN_V
//lint_checking USEMAC off
`define ITRX_SYNC_RSTN_SCAN_V
//lint_checking USEMAC on

module itrx_sync_rstn_scan #( parameter NUM_FLOPS = 32'd2 ) (
    input           rst_n,  // (I) reset, active LO
    input           clk,    // (I) clock
    input           scanmode, // (I) Scan test mode indicator
...
always @(posedge clk or negedge rst_n)
  begin
    ...
    assign dout = scanmode ? rst_n : sync_rstn[NUM_FLOPS-1];

...
`ifndef ITRX_SYNC_RSTP_V
//lint_checking USEMAC off
`define ITRX_SYNC_RSTP_V
//lint_checking USEMAC on

module itrx_sync_rstp #( parameter NUM_FLOPS = 32'd2 ) (
...
always @(posedge clk or posedge rst)
  begin
    ...
    assign dout = sync_rstp[NUM_FLOPS-1];

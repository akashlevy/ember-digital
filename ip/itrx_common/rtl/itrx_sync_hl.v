...
//                  wide pulse that detects a H->L change in value, active
...
`ifndef ITRX_SYNC_HL_V
//lint_checking USEMAC off
`define ITRX_SYNC_HL_V
//lint_checking USEMAC on

module itrx_sync_hl #( parameter WID       = 32'd1,        // default to one data bit

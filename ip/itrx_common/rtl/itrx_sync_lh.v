...
// Filename       : itrx_sync_lh.v
// Description    : 2-flop synchronizer, 3rd flop used to create a one-clk
//                  wide pulse that detects a L->H change in value, active
//                  LO reset to either 1's or 0's, parameterized data width
// 
// ==========================================================================
//
...
`ifndef ITRX_SYNC_LH_V
//lint_checking USEMAC off
`define ITRX_SYNC_LH_V
//lint_checking USEMAC on

module itrx_sync_lh #( parameter WID       = 32'd1,        // default to one data bit
